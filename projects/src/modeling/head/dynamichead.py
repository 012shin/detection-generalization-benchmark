...
class Diffution_DynamicHead(nn.Module):
    ...
    def __init__(self, cfg, roi_input_shape):
        ...
        rcnn_head = Diffution_RCNNHead(cfg, d_model, num_classes, dim_feedforward, nhead, dropout, activation)
        self.head_series = _get_clones(rcnn_head, num_heads)
...
class Diffution_RCNNHead(nn.Module):
...
class DynamicConv(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.hidden_dim = cfg.MODEL.DynamicConv.HIDDEN_DIM
        self.dim_dynamic = cfg.MODEL.DynamicConv.DIM_DYNAMIC
        self.num_dynamic = cfg.MODEL.DynamicConv.NUM_DYNAMIC
