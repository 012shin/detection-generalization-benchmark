...
from ..head import Diffution_DynamicHead
from src.layers.box_ops import box_cxcywh_to_xyxy, box_xyxy_to_cxcywh
...
class DiffusionDet(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # Build Dynamic Head.
        self.head = Diffution_DynamicHead(cfg=cfg, roi_input_shape=self.backbone.output_shape())
        # Loss parameters:
